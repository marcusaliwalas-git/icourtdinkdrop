-- Make a guest's mobile number optional: require only a name (email is still required for online
-- bookings, enforced below). Recreated verbatim from 20260831150000 with the guest-info check
-- relaxed from name+phone to name-only.
